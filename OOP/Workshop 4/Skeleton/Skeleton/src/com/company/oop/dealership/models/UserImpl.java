...
public class UserImpl implements User {
    ...
    private void setUsername(String username) {
        validateStringLengthAndPattern(username, USERNAME_LEN_MIN, USERNAME_LEN_MAX, USERNAME_LEN_ERR, USERNAME_REGEX_PATTERN, USERNAME_PATTERN_ERR);
    ...
    private void setPassword(String password) {
        validateStringLengthAndPattern(password, PASSWORD_LEN_MIN, PASSWORD_LEN_MAX, PASSWORD_LEN_ERR, PASSWORD_REGEX_PATTERN, PASSWORD_PATTERN_ERR);
